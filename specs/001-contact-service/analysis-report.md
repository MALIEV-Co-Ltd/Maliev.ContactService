...
| F034 | Constitution | HIGH | CLAUDE.md | Health checks - spec.md defines endpoints but no task validates implementation | Add task T050: Verify /contacts/liveness and /contacts/readiness match CLAUDE.md template |
